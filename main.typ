...
= Аннотация
Радиолокационное синтезирование апертуры является одной из ведущих технологий дистанционного зондирования, позволяющей получать детальные изображения земной и водной поверхности вне зависимости от погодных условий. Радиолокаторы с синтезированной апертурой (РСА) являются активными средствами наблюдения, т.е. используют облучение пространства зондирующим сигналом, приём и обработку отражённых сигналов. Принятый сигнал затем подвергается обработке для осуществления синтеза радиолокационных изображения, содержащих информацию о свойствах объекта наблюдения. 
...
Дальностно-доплеровский алгоритм разработан в 1978 году и является одним из наиболее распространённых алгоритмов синтеза РЛИ. Блок-схема алгоритма с модификациями для коррекции ТН (будут рассмотрены далее) представлена на рисунке @fig:RDA_model. Отличительной особенностью алгоритма является операция коррекции миграции дальности, которая выполняется во временной области по дальности и в частотной области по азимуту (области доплеровских частот), т.е. в дальностно-доплеровской области. Математические преобразования, осуществляемые на каждом шаге, и их смысл рассмотрены далее.
...
Для РСА авиационного базирования траекторные искажения вносят существенную фазовую ошибку (в сравнении с длиной волны в единицы см [Верба]), вызывая расфокусировку РЛИ. Следствиями фазовых искажений при синтезе РЛИ являются: 
